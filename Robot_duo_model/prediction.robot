...
Predict From Directory Green
    ${result}=    Predict Directory Green   ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS

Predict From Directory Red
    ${result}=    Predict Directory Red     ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS

Predict From Directory Pink
    ${result}=    Predict Directory Pink     ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS

Predict From Directory White
    ${result}=    Predict Directory White     ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS

Predict From Directory Cyan
    ${result}=    Predict Directory Cyan     ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS

Predict From Directory Blue
    ${result}=    Predict Directory Blue     ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS
    
Predict From Directory Orange
    ${result}=    Predict Directory Orange     ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS

Predict From Directory Yellow
    ${result}=    Predict Directory Yellow    ${MULTICLASS_MODEL_PATH}    ${CURDIR}/${IMAGE_PATH}   
    Should Be Equal    ${result}    PASS
